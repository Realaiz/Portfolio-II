...
import montecarlo from "@/public/montecarlo.png"
    ...
    <main id="homepage">
      <section id="hero-module" className="relative w-full h-screen">
        <div className="absolute inset-0">
          <Image src={heroImage} fill alt="hero background image of savannah with river" className="object-cover"/>
        </div>
        <div className="absolute inset-0 z-10">
          <Image src={lionSeparator} fill alt="lion separator" className="object-cover" />
        </div>
      ...
      <section id="showcase" className="bg-cream">
        ...
        <div className="py-12 px-72">
          <div className="flex justify-between gap-x-16">
            ...
            <div className="flex flex-col justify-center items-center">
              ...
              <p className="">Built a dashboard with sql integration, with fully functional authorisation and authentication.</p>
            </div>
          </div>
        </div>
        ...
        <div className="py-12 px-72">
          <div className="flex justify-between gap-x-16">
            <div className="flex flex-col justify-center items-center">
              <h1 className="font-semibold text-xl ">Stock Price Research</h1>
              <p className="">Researched applications of monte-carlo simulations for predicting stock prices on a brownian motion based model.</p>
            </div>
            <div className="flex-shrink-0">
              <Image src={montecarlo} width={475} height={250} className="rounded-lg" alt="Profile picture of me" />
            </div>
          </div>
        </div>
      </section>
